export const translations = {
  ar: {
    ...
    fieldCalories: 'السعرات الحرارية (kcal لكل 100غ أو للحبة) (اختياري)',
    fieldCaloriesHelp: 'مثال: 120 لصدر الدجاج، 72 للبيضة، 45 لحليب كانديا...',
  ...
  en: {
    ...
    fieldCalories: 'Calories (kcal per 100g or per piece) (Optional)',
    fieldCaloriesHelp: 'e.g. 120 for chicken breast, 72 for egg, 45 for Candia milk...',
